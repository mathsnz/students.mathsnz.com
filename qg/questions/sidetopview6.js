...
Question Name:|Draw Front, Side and Top View - 6 Blocks|
*/	

function sidetopview6(){var id=Math.random().toString(36).replace(/[^a-z]+/g,'').substr(0,20);img=randint(1,25)
var question="<img src='https://students.mathsnz.com/qg/blocks/Block6("+img+").jpg'><br>"
