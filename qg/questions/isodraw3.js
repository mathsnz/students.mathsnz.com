...
Question Name:|Draw Isometric Shape - 3 Blocks|
*/	

function isodraw3(){var id=Math.random().toString(36).replace(/[^a-z]+/g,'').substr(0,20);var question="<img src='https://students.mathsnz.com/qg/blocks/Block3.jpg'><br>"
