...
function trigpythag3bcosfindhy(){choice=randint(1,2);if(choice=1){a="";b=randint(5,100)/10;c="x";ang1=randint(5,80);ang2="";answer=(b/Math.cos(toRadians(ang1))).toPrecision(3);ang1=ang1+"°"}else{a=randint(5,100)/10;b="";c="x";ang1="";ang2=randint(5,80);answer=(a/Math.cos(toRadians(ang2))).toPrecision(3);ang2=ang2+"°"}
