...
Question Name:|Draw Isometric Shape from Side Views - 4/5 Blocks|
*/	

function isodrawfg4(){var id=Math.random().toString(36).replace(/[^a-z]+/g,'').substr(0,20);img=randint(1,6)
var question="<img src='https://students.mathsnz.com/qg/blocks/FTS4("+img+").png'><br>"
