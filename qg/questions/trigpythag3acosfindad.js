...
function trigpythag3acosfindad(){choice=randint(1,2);if(choice=1){a="";b="x";c=randint(5,100)/10;ang1=randint(5,80);ang2="";answer=(Math.cos(toRadians(ang1))*c).toPrecision(3);ang1=ang1+"°"}else{a="x";b="";c=randint(5,100)/10;ang1="";ang2=randint(5,80);answer=(Math.cos(toRadians(ang2))*c).toPrecision(3);ang2=ang2+"°"}
