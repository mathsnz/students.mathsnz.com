...
Question Name:|Trigonometry Sin find Angle|
*/	

function trigpythag2dsinfindang(){choice=randint(1,2);if(choice=1){a=randint(5,54)/10;b="";c=randint(55,100)/10;ang1="x";ang2="";answer=(toDegrees(Math.asin(a/c))).toPrecision(3);ang1=ang1+"°"}else{a="";b=randint(5,54)/10;c=randint(55,100)/10;ang1="";ang2="x";answer=(toDegrees(Math.asin(b/c))).toPrecision(3);ang2=ang2+"°"}
