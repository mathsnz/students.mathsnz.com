...
Question Name:|Trigonometry Tan find Opposite|
*/	

function trigpythag5atanfindop(){choice=randint(1,2);if(choice=1){a="x";b=randint(5,100)/10;c=""
ang1=randint(5,80);ang2="";answer=(Math.tan(toRadians(ang1))*b).toPrecision(3);ang1=ang1+"°"}else{a=randint(5,100)/10;b="x";c="";ang1="";ang2=randint(5,80);answer=(Math.tan(toRadians(ang2))*a).toPrecision(3);ang2=ang2+"°"}
