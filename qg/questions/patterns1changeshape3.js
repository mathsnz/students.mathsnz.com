...
Sort:|0.3|
Question Type:|TEG|
Question Name:|Patterns - Change Shape - 4 Shapes|
*/	

function patterns1changeshape3(){
	question = "";
	i=0;
	...
	shape4sides = shape1sides;
	while(shape1sides==shape4sides || shape2sides==shape4sides || shape3sides==shape4sides){
		shape4sides = randint(3,10);
	}
	...
	question += "<img src='https://www.jake4maths.com/generator/shape.php?border=0,0,0&fill="+color+"&points="+shape4sides+"&rotation=180' style='width:100px;height:100px;'>";
	question += "<img src='https://www.jake4maths.com/generator/shape.php?border=0,0,0&fill="+color+"&points="+shape1sides+"&rotation=180' style='width:100px;height:100px;'>";
	question += "<img src='https://www.jake4maths.com/generator/shape.php?border=0,0,0&fill="+color+"&points="+shape2sides+"&rotation=180' style='width:100px;height:100px;'>";
	question += "<br>What comes next:<br>";
	clicks=[];
	clicks.push(["<img src='https://www.jake4maths.com/generator/shape.php?border=0,0,0&fill="+color+"&points="+shape1sides+"&rotation=180' style='width:100px;height:100px;'>",'incorrect']);
	...
	clicks.push(["<img src='https://www.jake4maths.com/generator/shape.php?border=0,0,0&fill="+color+"&points="+shape3sides+"&rotation=180' style='width:100px;height:100px;'>",'correct']);
	clicks.push(["<img src='https://www.jake4maths.com/generator/shape.php?border=0,0,0&fill="+color+"&points="+shape4sides+"&rotation=180' style='width:100px;height:100px;'>",'incorrect']);
