...
Question Name:|Draw Isometric Shape from Side Views - 3 Blocks|
*/	

function isodrawfg3(){var id=Math.random().toString(36).replace(/[^a-z]+/g,'').substr(0,20);var question="<img src='https://students.mathsnz.com/qg/blocks/FTS3.png'><br>"
