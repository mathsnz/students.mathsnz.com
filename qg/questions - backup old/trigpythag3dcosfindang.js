...
Question Name:|Trigonometry Cos find Angle|
*/

function trigpythag3dcosfindang(){
	choice = randint(1,2);
	if(choice=1){
		a="";
		b=randint(5,54)/10;
		...
		ang1="x";
		ang2="";
		answer=(toDegrees(Math.acos(b/c))).toPrecision(3);
		ang1=ang1+"°";
	} else {
		a=randint(5,54)/10;
		b="";
		...
		ang1="";
		ang2="x";
		answer=(toDegrees(Math.acos(a/c))).toPrecision(3);
		ang2=ang2+"°";
	}
	tri=randint(1,8);
