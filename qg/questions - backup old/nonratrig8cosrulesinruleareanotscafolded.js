...
Question Name:|Cosine Rule then Sine Rule then Area - Not Scafolded|
*/

function nonratrig8cosrulesinruleareanotscafolded(){
  a=randint(30,50);
  b=randint(30,50);
  d=randint(45,80);
  angle=randint(45,80);
  ...
  var question = '<img width=300 src="https://www.jake4maths.com/generator/triangletriangle.php?rot='+rot+'&angle='+angle+'&angle2='+angle2+'&a='+a+'&b='+b+'&d='+d+'&sidea=1&sideb=0&sidec=1&sided=0&sidee=1&anga=0&angb=1&angc=0&angd=0&ange=0&angf=1"><br>Total area = '+numberanswer(totalarea)+'<br>';
