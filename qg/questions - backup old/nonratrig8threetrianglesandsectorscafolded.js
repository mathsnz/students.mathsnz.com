...
Question Name:|Three Triangles and a Sector - Scafolded|
*/

function nonratrig8threetrianglesandsectorscafolded(){
  a=randint(30,50);
  b=randint(30,50);
  d=randint(20,40);
  h=randint(30,50);
  ...
  var answer = "v = "+v+", w = "+w+", x = "+x+", y = "+y+", z = "+z+", area 1 = "+area1+", area 2 = "+area2+", area 3 = "+area3+", area 4 = "+area4+", total area = "+totalarea;
  var question = '<img width=300 src="https://www.jake4maths.com/generator/triangletriangletrianglesector.php?rot='+rot+'&angle='+angle+'&angle2='+angle2+'&angle3='+angle3+'&angle4='+angle4+'&a='+a+'&b='+b+'&d='+d+'&h='+h+'&sidea=x&sideb=v&sidec=1&sided=z&sidee=1&sidef=0&sideg=0&sideh=1&sidei=1&anga=0&angb=0&angc=y&angd=w&ange=1&angf=1&angg=1&angh=0&angi=0&angj=1"><br>side v = <br>'+numberanswer(v)+'<br><small>(Hint: use '+displaye+' and '+angle2+'° and '+displayangF+'°)</small><br><br>angle w = <br>'+numberanswer(w)+'<br><small>(Hint: angles in a triangle add to 180°)</small><br><br>area of triangle with w in it = <br>'+numberanswer(area1)+'<br><small>(Hint: use '+displaye+' and v and w°)</small><br><br>side x = <br>'+numberanswer(x)+'<br><small>(Hint: use '+h+' and '+displayi+' and '+displayangJ+'°)</small><br><br>area of triangle with x and '+displayangJ+'° in it = <br>'+numberanswer(area2)+'<br><small>(Hint: use '+h+' and '+displayi+' and '+displayangJ+'°)</small><br><br>angle y = <br>'+numberanswer(y)+'<br><small>(Hint: use x, v and '+displayc+')</small><br><br>area of triangle with y° in it = <br>'+numberanswer(area3)+'<br><small>(Hint: use v and x and y°)</small><br><br>side z = <br>'+numberanswer(z)+'<br><small>(Hint: use '+displaye+' and '+angle2+'° and w°)</small><br><br>Area of sector = <br>'+numberanswer(area4)+'<br><small>(Hint: use z and '+angle3+'°)</small><br><br>Total area = <br>'+numberanswer(totalarea)+'<br><small>(Hint: add the four areas together)</small>';
