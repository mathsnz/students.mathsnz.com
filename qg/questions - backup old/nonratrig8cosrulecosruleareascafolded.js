...
Question Name:|Cosine Rule then Cosine Rule then Area - Scafolded|
*/

function nonratrig8cosrulecosruleareascafolded(){
  a=randint(30,50);
  b=randint(30,50);
  d=randint(45,80);
  angle=randint(45,80);
  ...
  var answer = "x = "+x+", y = "+y+", area 1 = "+area1+", area 2 = "+area2+", total area = "+totalarea;
  var question = '<img width=300 src="https://www.jake4maths.com/generator/triangletriangle.php?rot='+rot+'&angle='+angle+'&angle2='+angle2+'&a='+a+'&b='+b+'&d='+d+'&sidea=1&sideb=x&sidec=1&sided=1&sidee=1&anga=0&angb=1&angc=0&angd=y&ange=0&angf=0"><br>length x = <br>'+numberanswer(x)+'<br><small>(Hint: use '+a+' and '+displayc+' and '+displayangB+'°)</small><br><br>area of triangle with '+displayangB+'° in it = <br>'+numberanswer(area1)+'<br><small>(Hint: use '+a+' and '+displayc+' and '+displayangB+'°)</small><br><br>angle y = <br>'+numberanswer(y)+'<br><small>(Hint: use '+displayd+' and '+displaye+' and x)</small><br><br>Area of other triange = <br>'+numberanswer(area2)+'<br><small>(Hint: use y° and x and '+displaye+')</small><br><br>Total area = <br>'+numberanswer(totalarea)+'<br><small>(Hint: add the two areas together)</small>';
